...
try:
    # แก้ไขชื่อไฟล์ให้ตรงกับที่ LSTM_ForexTraderScriptV2.py export ออกมา
    model_path = os.path.join(EXPORT_DIR, 'lstm_forex_model_combined.keras')
    ...
    print("โปรดตรวจสอบว่าไฟล์ 'lstm_forex_model_combined.keras', 'lstm_forex_model_combined_scaler.pkl', และ 'lstm_forex_model_combined_features_list.pkl' อยู่ในโฟลเดอร์ 'exported_models' และชื่อไฟล์ถูกต้อง")
...
def predict():
    ...
    try:
        ...
        BUY_THRESHOLD = 0.51 # ตัวอย่าง: ถ้าความน่าจะเป็น Buy > 55%
        SELL_THRESHOLD = 0.50 # ตัวอย่าง: ถ้าความน่าจะเป็น Sell < 45% (หมายถึงความน่าจะเป็น Buy ต่ำ)
